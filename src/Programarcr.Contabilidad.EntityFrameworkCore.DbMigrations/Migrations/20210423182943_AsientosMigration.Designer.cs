...
{
    [DbContext(typeof(ContabilidadMigrationsDbContext))]
    [Migration("20210423182943_AsientosMigration")]
    partial class AsientosMigration
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Programarcr.Contabilidad.Asientos.Asiento", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("ACCAsiento");
                });

            modelBuilder.Entity("Programarcr.Contabilidad.Asientos.Linea", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Programarcr.Contabilidad.Configuracion.CentroCosto", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasIndex("Nombre")
                        .IsUnique()
                        .HasDatabaseName("IX_Nombre")
                        .HasFilter("[Nombre] IS NOT NULL");

                    b.ToTable("ACCCentroCosto");
                });

            modelBuilder.Entity("Programarcr.Contabilidad.Configuracion.Moneda", b =>
                {
            ...
            modelBuilder.Entity("Programarcr.Contabilidad.Configuracion.TipoCambio", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasIndex("MonedaId", "Fecha")
                        .IsUnique()
                        .HasDatabaseName("MonedaFechaIndex")
                        .HasFilter("[MonedaId] IS NOT NULL");

                    b.ToTable("ACCTipoCambio");
                });

            modelBuilder.Entity("Programarcr.Contabilidad.Cuentas.Cuenta", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(21)
                        .HasColumnType("nvarchar(21)");
            ...
            modelBuilder.Entity("Programarcr.Contabilidad.Periodos.PeriodoContable", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Programarcr.Contabilidad.Asientos.Asiento", b =>
                {
                    b.HasOne("Programarcr.Contabilidad.Periodos.PeriodoContable", "Periodo")
                        .WithMany()
            ...
            modelBuilder.Entity("Programarcr.Contabilidad.Asientos.Linea", b =>
                {
                    b.HasOne("Programarcr.Contabilidad.Asientos.Asiento", null)
                        .WithMany("Lineas")
                        .HasForeignKey("AsientoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Programarcr.Contabilidad.Cuentas.Cuenta", "Cuenta")
                        .WithMany()
                        .HasForeignKey("CuentaId");

                    b.HasOne("Programarcr.Contabilidad.Configuracion.Moneda", "Moneda")
                        .WithMany()
            ...
            modelBuilder.Entity("Programarcr.Contabilidad.Cuentas.Cuenta", b =>
                {
                    ...
                    b.HasOne("Programarcr.Contabilidad.Cuentas.Cuenta", "Parent")
                        .WithMany("Children")
            ...
            modelBuilder.Entity("Programarcr.Contabilidad.Periodos.PeriodoContable", b =>
                {
                    b.OwnsOne("Programarcr.Contabilidad.ValueObjects.MesContable", "Fin", b1 =>
                        {
                            b1.Property<int>("PeriodoContableId")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("int")
                                .UseIdentityColumn();
                            ...
                            b1.HasKey("PeriodoContableId");

                            b1.ToTable("ACCPeriodoContable");

                            b1.WithOwner()
                                .HasForeignKey("PeriodoContableId");
                        });

                    b.OwnsOne("Programarcr.Contabilidad.ValueObjects.MesContable", "Inicio", b1 =>
                        {
                            b1.Property<int>("PeriodoContableId")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("int")
