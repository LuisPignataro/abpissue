...
namespace Programarcr.Contabilidad.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update ContabilidadDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update ContabilidadEfCoreEntityExtensionMappings to extend the IdentityUser entity
